...
commentRouter
    .put('/:commentId', bearerGuard, commentIdValidation, commentsHandler.changeCommentByCommentId)
    .put('/:commentId/like-status', bearerGuard, commentIdValidation, commentsHandler.changeCommentReaction)
