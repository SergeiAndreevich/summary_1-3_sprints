...
exports.commentRouter
    .put('/:commentId', bearerAuthorization_1.bearerGuard, commentId_validation_1.commentIdValidation, commentInput_validation_1.commentInputValidation, errors_middleware_1.checkValidationErrors, commentsHandler.changeCommentByCommentId)
    .put('/:commentId/like-status', bearerAuthorization_1.bearerGuard, commentId_validation_1.commentIdValidation, likeStatus_validation_1.likeStatusValidation, errors_middleware_1.checkValidationErrors, commentsHandler.changeCommentReaction)
    .get('/:id', bearerAuthorization_1.optionalBearerGuard, id_validation_1.idValidation, errors_middleware_1.checkValidationErrors, commentsHandler.findCommentById)
    .delete('/:commentId', bearerAuthorization_1.bearerGuard, commentId_validation_1.commentIdValidation, errors_middleware_1.checkValidationErrors, commentsHandler.removeCommentByCommentId);
